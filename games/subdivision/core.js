...
(function (root, factory) {
  ...
  const WEAPONS = {
    ...
    'SSG 08': { type: 'sniper',  firerate: 2,  pellets: 1, range: 1000, dmg: { head: 299, body: 75, legs: 66 } },
    'AWP':    { type: 'sniper',  firerate: 1.25,   pellets: 1, range: 1000, dmg: { head: 448, body: 112, legs: 86 } },
