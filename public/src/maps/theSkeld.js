...
export const THE_SKELD = createMapDefinition({
  ...
  stations: [
    ...
    stationAt("skeld-vent-hallway", "maintenance", "admin", 995, 433, "vent-cafeteria-admin", "Hallway"),
    ...
    stationAt("skeld-vent-lower-engine", "maintenance", "lower-engine", 295, 510, "vent-lower-engine"),
