...
export const THE_SKELD = createMapDefinition({
  ...
  rooms: [
    { id: "cafeteria", name: "Cafeteria", x: 4.82, z: -19.97, width: 34.18, depth: 34.04, shape: "octagon", assetKey: "skeld-cafeteria", artAlpha: 0.84, colour: 0x5b6566 },
    { id: "upper-engine", name: "Upper Engine", x: -45.77, z: -19.7, width: 14.21, depth: 15.81, assetKey: "skeld-engine", artCrop: { x: 416, y: 45, width: 608, height: 305 }, artAlpha: 0.88, colour: 0x4a342a },
    { id: "reactor", name: "Reactor", x: -58.5, z: -1.21, width: 13.13, depth: 24.39, shape: "octagon", colour: 0x512d35 },
    { id: "security", name: "Security", x: -33.64, z: -2.28, width: 7.91, depth: 16.08, colour: 0x3b334f },
    { id: "medbay", name: "MedBay", x: -18.16, z: -7.24, width: 18.23, depth: 16.89, shape: "octagon", assetKey: "skeld-medbay", artCrop: { x: 0, y: 0, width: 520, height: 520 }, artAlpha: 0.88, colour: 0x1f5153 },
    { id: "lower-engine", name: "Lower Engine", x: -45.84, z: 18.23, width: 14.34, depth: 15.81, assetKey: "skeld-engine", artCrop: { x: 416, y: 632, width: 608, height: 300 }, artAlpha: 0.88, colour: 0x4a342a },
    { id: "electrical", name: "Electrical", x: -16.82, z: 13.07, width: 15.55, depth: 16.75, shape: "octagon", colour: 0x594437 },
    { id: "storage", name: "Storage", x: 0.47, z: 22.98, width: 18.49, depth: 28.01, colour: 0x443c32 },
  ...
  stations: [
    ...
    station("skeld-vent-a", "maintenance", "upper-engine", -49.77, -19.7, "skeld-vent-b"),
    station("skeld-vent-b", "maintenance", "reactor", -58.5, 4.79, "skeld-vent-a"),
    station("skeld-vent-c", "maintenance", "navigation", 59.84, -0.28, "skeld-vent-d"),
    station("skeld-vent-d", "maintenance", "shields", 35.45, 25.11, "skeld-vent-c"),
  ...
  spawnPoints: [
    [16.82, -19.97], [13.6, -16.33], [13.31, -11.48], [8.46, -11.19],
    [4.82, -7.97], [1.18, -11.19], [-3.67, -11.48], [-3.96, -16.33],
    [-7.18, -19.97], [-3.96, -23.61], [-3.67, -28.46], [1.18, -28.75],
    [4.82, -31.97], [8.46, -28.75], [13.31, -28.46], [13.6, -23.61]
  ],
  collisionRects: [
    { id: "skeld-emergency-table", kind: "table", roomId: "cafeteria", x: 4.82, z: -19.97, width: 5.2, depth: 3.2 },
    { id: "skeld-admin-table", kind: "table", roomId: "admin", x: 20.51, z: 8.18, width: 4.5, depth: 2.5 },
    { id: "skeld-med-scanner", kind: "scanner", roomId: "medbay", x: -22.66, z: -11.74, width: 3, depth: 3 },
    { id: "skeld-storage-crates", kind: "cargo", roomId: "storage", x: 4.97, z: 20.48, width: 3.8, depth: 3.4 }
  ],
  theme: {
    worldScale: 42,
