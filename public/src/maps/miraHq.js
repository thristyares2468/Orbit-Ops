...
export const MIRA_HQ = createMapDefinition({
  ...
  rooms: [
    { id: "greenhouse", name: "Greenhouse", x: 27.97, z: -39.82, width: 30.91, depth: 11.42, shape: "octagon", assetKey: "mira-greenhouse", artAlpha: 0.95, colour: 0x275544, gridColour: 0xa4ffd1 },
    { id: "office", name: "Office", x: 18.23, z: -26.12, width: 11.42, depth: 15.29, colour: 0x4b3c54 },
    { id: "admin", name: "Admin", x: 37.55, z: -26.12, width: 11.76, depth: 15.29, assetKey: "mira-admin", artAlpha: 0.95, colour: 0x46364d },
    { id: "reactor", name: "Reactor", x: -19.82, z: -7.31, width: 14.95, depth: 21.34, colour: 0x533244 },
    { id: "laboratory", name: "Laboratory", x: 2.69, z: -5.12, width: 14.95, depth: 16.97, assetKey: "mira-laboratory", artAlpha: 0.95, colour: 0x34546a },
    ...
    { id: "medbay", name: "MedBay", x: 20.41, z: 33.85, width: 10.75, depth: 13.61, assetKey: "mira-medbay", artAlpha: 0.92, colour: 0x285159 },
    { id: "storage", name: "Storage", x: 33.35, z: 22.09, width: 9.41, depth: 13.94, assetKey: "mira-storage", artAlpha: 0.92, colour: 0x51483b },
    { id: "cafeteria", name: "Cafeteria", x: 50.9, z: 24.11, width: 24.36, depth: 18.31, assetKey: "mira-cafeteria", artAlpha: 0.92, colour: 0x53606c },
